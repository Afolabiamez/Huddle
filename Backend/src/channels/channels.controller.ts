...
import { ChannelMemberResponseDto, ChannelResponseDto } from './dto/channel-response.dto.js';
...
export class ChannelsController {
  ...
  @Get()
  @ApiOperation({ summary: 'List public channels plus private channels the user has joined' })
  ...
  findOne(@Param('id') id: string) {
    return this.channelsService.findOneOrThrow(id);
  }
